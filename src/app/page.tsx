...
export default function Home() {
  ...
  const analyzeChannel = async () => {
    ...
    if ((usesThisMonth?.length || 0) >= monthlyLimit) {
      setAnalysisData({
        error: tier === 'pro'
            ? "You've reached your Pro limit of 500 analyses this month."
            : tier === 'starter'
                ? "You've reached your Starter limit of 100 analyses this month. Upgrade to Pro!"
                        ...
                        <div className="bg-gray-800/50 rounded-2xl p-8 border border-gray-700">
                          <div className="space-y-6">
                            ...
                            <div className="flex gap-4">
                              <button onClick={handleProfileSave} className="px-8 py-4 bg-green-600 rounded-xl hover:bg-green-700 transition">
                                Save Profile
                              </button>
                              <button onClick={() => setEditingChannel(null)} className="px-8 py-4 bg-gray-700 rounded-xl hover:bg-gray-600 transition">
                                Cancel
                              </button>
                            </div>
                          </div>

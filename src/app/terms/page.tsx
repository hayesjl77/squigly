        ...
        <div className="min-h-screen bg-gradient-to-b from-[#0f172a] via-[#0f172a] to-black text-white">
            ...
            <div className="max-w-4xl mx-auto py-16 px-6">
                ...
                <div className="prose prose-invert prose-headings:text-purple-300 prose-a:text-purple-400 prose-a:no-underline hover:prose-a:underline max-w-none space-y-12 text-gray-300">
                    ...
                    <h2 className="text-4xl font-bold mt-16 mb-6 border-b border-gray-700 pb-4">1. Acceptance of Terms</h2>
                    ...
                    <h2 className="text-4xl font-bold mt-16 mb-6 border-b border-gray-700 pb-4">2. Description of Service</h2>
                    <p className="text-gray-300">
                    ...
                    <h2 className="text-4xl font-bold mt-16 mb-6 border-b border-gray-700 pb-4">3. User Accounts & Authentication</h2>
                    <p className="text-gray-300">
                    ...
                    <h2 className="text-4xl font-bold mt-16 mb-6 border-b border-gray-700 pb-4">4. Payments & Subscriptions</h2>
                    <p className="text-gray-300">
                    ...
                    <h2 className="text-4xl font-bold mt-16 mb-6 border-b border-gray-700 pb-4">5. Usage Limits & Fair Use</h2>
                    <p className="text-gray-300">
                    ...
                    <h2 className="text-4xl font-bold mt-16 mb-6 border-b border-gray-700 pb-4">6. Intellectual Property</h2>
                    <p className="text-gray-300">

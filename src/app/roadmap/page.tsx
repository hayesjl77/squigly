                    ...
                    <div className="space-y-16">
                        <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/40 rounded-3xl p-8 border border-pink-500/30">
                            ...
                            <p className="text-gray-200 mb-4 text-lg leading-relaxed">
                                TikTok (official Discovery API + trends/metadata), Instagram Reels (Graph API analytics & publishing),
                                X/Twitter (short-form video & thread support via API v2).
                            </p>
                        ...
                        <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/40 rounded-3xl p-8 border border-purple-500/30">
                            ...
                            <p className="text-gray-200 mb-4 text-lg leading-relaxed">
                                Advanced multimodal models (improved Whisper, CLIP-style visual+audio understanding, emotion/sarcasm detection,
                                key moment extraction, viral probability scoring, real-time live stream analysis).
                            </p>
                            <p className="text-gray-400 italic text-base">
